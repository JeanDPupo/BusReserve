package co.edu.unimagdalena.busreserve.security.web;

import co.edu.unimagdalena.busreserve.security.domine.AppUser;
import co.edu.unimagdalena.busreserve.security.domine.Role;
import co.edu.unimagdalena.busreserve.security.dto.AuthDtos.*;
import co.edu.unimagdalena.busreserve.security.jwt.JwtService;
import co.edu.unimagdalena.busreserve.security.repo.AppUserRepository;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> register(@Valid @RequestBody RegisterRequest req) {
        ...
        var roles = Optional.ofNullable(req.roles()).filter(r -> !r.isEmpty())
                .orElseGet(() -> Set.of(Role.ROLE_PASSENGER));
